...
//            resetToLocalGame();
    ...
    private void updateActionButtonsState() {
        ...
        offerDrawMenuItem.setDisable(isGameOver || !(isPlayingPvp || currentMode == GameMode.ANALYSIS));
        offerDrawButton.setDisable(isGameOver || !(isPlayingPvp || currentMode == GameMode.ANALYSIS));
